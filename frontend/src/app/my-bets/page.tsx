...
export default function MyBetsPage() {
  ...
  const categories = [
    { id: 'all', label: 'All Bets', count: bets.length },
    {
      id: 'active',
      label: 'Active',
      count: bets.filter((bet) => bet.status === 'active').length,
    },
    {
      id: 'unredeemed',
      label: 'Unredeemed',
      count: bets.filter((bet) => bet.status === 'unredeemed').length,
    },
    {
      id: 'complete',
      label: 'Complete',
      count: bets.filter((bet) => bet.status === 'won' || bet.status === 'lost').length,
    },
  ];
  ...
  const filteredBets =
    activeCategory === 'all' ? bets : bets.filter((bet) => bet.status === activeCategory);
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-3">
                              ...
                              <div>
                                ...
                                <div className="text-medium-gray text-sm">{bet.priceRange}</div>
                              </div>
                            </div>
